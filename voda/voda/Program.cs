...
while (true)
{
    ...
    while (active != "exit")
    {
        ...
        switch (active)
        {
            case "admin":
                ...
                switch (act)
                {
                    ...
                    case "change":
                        ...
                        break;
                    case "del":
                        admin.Del(path_journal, path_student, path_auth_st, path_teacher, path_auth_te);
                        break;
                    case "add":
                        admin.Add(path_journal, path_student, path_teacher, ref journal_inf);
                        break;
                    case "ex":
                        active = "exit";
                        break;
            ...
            case "student":
                Console.WriteLine("Успешный вход");
                student.st_info(path_journal, ref active, Login, journal_inf, path_auth_st);
                goto case "final_st";
            case "teacher":
                Console.WriteLine("Успешный вход");
                prepod.te_info(path_journal, ref active, Login, journal_inf, path_auth_te);
                goto case "final_te";
            case "final_ad":
                active = "admin";
                goto case "admin";
